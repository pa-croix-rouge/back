...
public class EventControllerTest {
    ...
    public void eventRegisterSuccessTest() throws Exception {
        ...
        EventRegistrationRequest eventRegistrationRequest = new EventRegistrationRequest("1", "0", timeWindowId, "1");
    ...
    public void eventRegisterTwiceFailTest() throws Exception {
        EventRegistrationRequest eventRegistrationRequest = new EventRegistrationRequest("1", "0", "0", "1");
    ...
    public void eventRegisterWhenAnEventIsFullFailTest() throws Exception {
        EventRegistrationRequest eventRegistrationRequest = new EventRegistrationRequest("1", "0", "0", "2");
    ...
    public void eventUpdatesSessionSuccessTest() throws Exception {
        ...
        mockMvc.perform(get("/event/sessions/" + eventId )
                ...
                .andExpect(jsonPath("$[0].timeWindows[0].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).toString()))
                .andExpect(jsonPath("$[0].timeWindows[0].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[1].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(7).toString()))
                .andExpect(jsonPath("$[1].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(7).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[2].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(14).toString()))
                .andExpect(jsonPath("$[2].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(14).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[2].timeWindows[0].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(14).toString()))
                .andExpect(jsonPath("$[2].timeWindows[0].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(14).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[3].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(21).toString()))
                .andExpect(jsonPath("$[3].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(21).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[3].timeWindows[0].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(21).toString()))
                .andExpect(jsonPath("$[3].timeWindows[0].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(21).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[4].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(28).toString()))
                .andExpect(jsonPath("$[4].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(28).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
                ...
                .andExpect(jsonPath("$[4].timeWindows[0].start").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(28).toString()))
                .andExpect(jsonPath("$[4].timeWindows[0].end").value(timestampToLocalDateTime(singleEventCreationRequest.getStart()).plusDays(28).plusMinutes((long) singleEventCreationRequest.getEventTimeWindowDuration() * singleEventCreationRequest.getEventTimeWindowOccurrence()).toString()))
