...
public class EventControllerTest {
    ...
    public void eventUpdatesSessionSuccessTest() throws Exception {
        ...
        mockMvc.perform(get("/event/sessions/" + eventId )
                ...
                .andExpect(jsonPath("$[3].start").value(timestampToLocalDateTime(Timestamp.valueOf(eventStart.toLocalDateTime().plusDays(21))).toString()))
                .andExpect(jsonPath("$[3].end").value(timestampToLocalDateTime(Timestamp.valueOf(eventEnd.toLocalDateTime().plusDays(21))).toString()))
                ...
                .andExpect(jsonPath("$[4].start").value(timestampToLocalDateTime(Timestamp.valueOf(eventStart.toLocalDateTime().plusDays(28))).toString()))
                .andExpect(jsonPath("$[4].end").value(timestampToLocalDateTime(Timestamp.valueOf(eventEnd.toLocalDateTime().plusDays(28))).toString()))
