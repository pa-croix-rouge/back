...
public class InDBMockRepositoryConfig {
    ...
    public InDBMockRepositoryConfig(PasswordEncoder passwordEncoder) {
        ...
        beneficiary1 = new Beneficiary(null, beneficiaryUser, "beneficiaryFirstName", "beneficiaryLastName", "+33 6 00 00 00 00", true, LocalDate.of(2000, 6, 1), "1223", List.of(), 0.0);
