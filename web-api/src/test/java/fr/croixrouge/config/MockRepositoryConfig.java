...
public class MockRepositoryConfig {
    ...
    public EventRepository eventTestRepository() {
        ...
        for (int i = 0; i < 3; i++) {
            eventTimeWindowList2.add(new EventTimeWindow(new ID(String.valueOf(i)), eventStartDate2.plusMinutes(i * 40), eventStartDate2.plusMinutes((i + 1) * 40), maxParticipants2 / 3, participants2));
        }
